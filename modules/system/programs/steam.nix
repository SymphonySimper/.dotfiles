{ lib, config, ... }:
let
  cfg = config.my.system.programs.steam;
...
in
{
  options.my.system.programs.steam = {
      ...
      type = lib.types.submodule {
        options = {
          width = lib.mkOption {
            ...
            default = config.my.gui.display.width;
          };
          height = lib.mkOption {
            type = lib.types.ints.positive;
            description = "Height of the display";
            default = config.my.gui.display.height;
          };
          refreshRate = lib.mkOption {
            type = lib.types.ints.positive;
            description = "Refresh rate fo the display";
            default = config.my.gui.display.refreshRate;
          };
        };
      };
    };
